...
export default function Vault() {
  ...
  const aaveApyPct: string | undefined = (() => {
    ...
    // currentLiquidityRate is in Ray (1e27), represents annualized supply APY
    const pct = (Number(rate) / 1e27) * 100
        ...
        <div className="lg:col-span-5 flex flex-col gap-5">
          ...
          <div className="bg-surface-container-lowest border border-outline-variant/40 rounded-xl p-6">
            ...
            <div className="text-xs text-on-surface-variant leading-relaxed space-y-2">
              ...
              <p>
                Yield is generated by supplying USDC to <strong>Aave V3 on Base</strong>,
                one of the most battle-tested decentralized lending protocols. The strategy
                is fully non-custodial and positions can be withdrawn at any time.
